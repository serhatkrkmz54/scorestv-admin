...
import TeleskorSaglikClient from "@/components/TeleskorSaglikClient";

export const dynamic = "force-dynamic";

/** Sistem sağlığı — YALNIZ ADMIN (gerekçe: teleskor/market/page.tsx). */
