...
import TeleskorDenetimClient from "@/components/TeleskorDenetimClient";

export const dynamic = "force-dynamic";

/** Denetim kaydı — YALNIZ ADMIN (gerekçe: teleskor/market/page.tsx). */
