...
import TeleskorOrdersClient from "@/components/TeleskorOrdersClient";

export const dynamic = "force-dynamic";

/** Teleskor market siparişleri — YALNIZ ADMIN (gerekçe: market/page.tsx). */
export default async function TeleskorOrdersPage() {
