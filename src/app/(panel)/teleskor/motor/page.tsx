...
import TeleskorMotorClient from "@/components/TeleskorMotorClient";

export const dynamic = "force-dynamic";

/**
 * Motor operasyonu — YALNIZ ADMIN (gerekçe: teleskor/market/page.tsx).
 *
